    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="bg-gradient-to-br from-emerald-500 to-teal-600 p-8 rounded-full shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <input
            ...
            className="w-full px-6 py-4 text-xl border-2 border-slate-300 rounded-xl focus:ring-4 focus:ring-emerald-500 focus:border-emerald-500 transition-all"
            autoFocus
            required
          />
